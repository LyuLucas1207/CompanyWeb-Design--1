...
//     const imageContainer = document.querySelector('.section19_images');
//     const images = document.querySelectorAll('.section19_img');
//     const buttons = document.querySelectorAll('.section19_min');
//     let currentIndex = 0;
...
//     // 自动切换图片
//     setInterval(nextImage, 5000); // 每3秒切换一次
// });
// document.addEventListener("DOMContentLoaded", function() {
